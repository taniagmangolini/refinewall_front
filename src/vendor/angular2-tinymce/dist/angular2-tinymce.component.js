...
var TinymceComponent = TinymceComponent_1 = (function () {
    function TinymceComponent(zone, config) {
		...
		this.options.plugins= "paste";
		this.options.paste_data_images = true;
		this.options.pastetext = true; 
		this.options.paste_auto_cleanup_on_paste = true;
		
		this.options.paste_preprocess = function(pl, o) {
			//somente permite colar imagens
